...
def update_module_icon(cr, registry):
    ...
    env['viin.brand.base'].update_menu_icon('viin_brand_base', 'base.menu_administration', icon_path='static/description/settings.png')
    env['viin.brand.base'].update_menu_icon('viin_brand_base', 'base.menu_management', icon_path='static/description/modules.png')
